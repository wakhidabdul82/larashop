    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <div class="login-wrapper my-auto">
            ...
            <form action="{{route('login')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="email@example.com" required autocomplete="email" autofocus>
                @error('email')
        ...
        <div class="col-sm-6 px-0 d-none d-sm-block">
          <img src="{{asset('assets/frontend/imgs/shop/product-16-1.jpg')}}" alt="login image" class="login-img">
        </div>
      </div>
    </div>
  </main>
